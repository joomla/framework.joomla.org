...
use Joomla\Status\View\Package\PackageHtmlView;

/**
 * Test class for \Joomla\Status\View\Package\PackageHtmlView
 */
class PackageHtmlViewTest extends PackageTestCase
{
	/**
	 * Test object
	 *
	...
	protected function setUp()
	{
		...
		$this->object = new PackageHtmlView($this->mockModel, $this->mockRenderer);
	}

	/**
	 * @testdox  Ensure render() returns the data received from the renderer
	 *
	 * @covers   \Joomla\Status\View\Package\PackageHtmlView::render
